...
Add build status badge for publish step to your projects README: [![Publish Status](https://github.com/TractorZoom/-tractorzoom equipment attributes/workflows/publish/badge.svg)](https://github.com/TractorZoom/-tractorzoom equipment attributes/actions)

Add build status badge for PR verify step to your projects README: [![Publish Status](https://github.com/TractorZoom/-tractorzoom equipment attributes/workflows/pull_request/badge.svg)](https://github.com/TractorZoom/-tractorzoom equipment attributes/actions)
